                ...
                >
                    ...
                    <div className="hidden md:flex items-center">
                        <motion.button
                            ...
                            whileTap={{ scale: 0.95 }}
                            className="bg-gradient-to-r from-neon-cyan to-neon-blue text-white px-6 py-2 rounded-full font-bold text-sm shadow-[0_0_15px_rgba(0,243,255,0.3)] hover:shadow-[0_0_25px_rgba(0,243,255,0.6)] transition-all border border-white/20"
                        >
                            Live Scorecard
                        </motion.button>
                    </div>
                    ...
                    >
                        <div className="flex flex-col gap-6">
                            ...
                            <motion.button
                                ...
                                className="w-full bg-gradient-to-r from-neon-cyan to-neon-blue text-white py-4 rounded-xl font-bold text-lg shadow-[0_0_15px_rgba(0,243,255,0.3)] mt-4"
                            >
                                Live Scorecard
                            </motion.button>
                        </div>
