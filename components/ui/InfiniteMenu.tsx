...
void main() {
    ...
    vAlpha = smoothstep(0.5, 1., normalize(worldPosition.xyz).z) * .9 + .3; // Increased min alpha for visibility
    vUvs = aModelUvs;
...
void main() {
    ...
    outColor.rgb = (outColor.rgb - 0.5) * 1.2 + 0.5; // Contrast
    outColor.rgb *= 1.3; // Brightness
    ...
    public update(deltaTime: number, targetFrameDuration = 16): void {
        ...
        if (this.isPointerDown) {
            ...
            if (this.snapTargetDirection) {
                ...
                const autoRotateSpeed = 0.05 * timeScale;
                const autoRotateQuat = quat.setAxisAngle(quat.create(), [0, 1, 0], autoRotateSpeed);
...
class InfiniteGridMenu {
    ...
    private initTexture(): void {
        ...
        const fallbackImage = 'https://images.unsplash.com/photo-1551958219-acbc608c6377?w=512&q=80'; // Reliable fallback
                ...
                item =>
                    new Promise<HTMLImageElement>((resolve) => {
                        ...
                        img.onerror = () => {
                            ...
                            // Avoid infinite loop if fallback fails by removing handler
                            img.onerror = null;
                            // Determine if we need to set onload again or if it just works. 
                            // The safest is to create a new image properly.
